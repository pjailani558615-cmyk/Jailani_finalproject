...
<head>
    ...
    <title>Staff Login - Blood Donation System</title>
...
<body>
    <div class="login-container">
        ...
        <nav class="top-nav">
            <a href="/userregister" class="nav-btn">User</a>
        ...
        <p style="text-align: center; margin-top: 20px;">
            New staff? <a href="{{ route('staff.register') }}" style="color: #FEFDF1;">Register here</a>
        </p>
