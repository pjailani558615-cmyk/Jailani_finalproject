...
<head>
    ...
    <title>Admin Registration - Blood Donation System</title>
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
</head>
<body>
    <div class="form-container admin-sign-up">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <p><a href="{{ route('admin.login') }}" style="color: #FEFDF1;">← Back to Admin Login</a></p>
        </div>
    </div>
</body>
</html>
